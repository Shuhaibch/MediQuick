      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                CategoryTileWidget(title: 'All Categories'),
                SizedBox(height: height * 0.005),
                CategoryTileWidget(title: 'Dioganostic Devices'),
                SizedBox(height: height * 0.005),
                CategoryTileWidget(title: 'Sergical Tools'),
                SizedBox(height: height * 0.005),
                CategoryTileWidget(title: 'Protective Gear'),
              ],
            ),
          ),
          Spacer(),
